...
export function Rating({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: onMouseLeave is on a radiogroup widget role, which is valid
		// biome-ignore lint/a11y/useAriaPropsSupportedByRole: conditional role/aria props confuse static analysis; implementation is correct
		<div
		...
		>
			{stars.map((star) => {
				...
				return (
					// biome-ignore lint/a11y/noStaticElementInteractions: conditional role="radio" with keyboard handler is valid; static analysis misses the conditional
					// biome-ignore lint/a11y/useAriaPropsSupportedByRole: aria-checked is conditional on role="radio"; correct when interactive
					<span
						key={star}
